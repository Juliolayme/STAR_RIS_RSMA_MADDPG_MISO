...
với ràng buộc QoS cho cấu hình truyền đường xuống một trạm gốc đơn anten
($M=1$, SISO), một STAR-RIS có $N=32$ phần tử ở chế độ chia sẻ năng lượng
...
chuyển đổi MS/TS, RIS chủ động, RIS đa lớp hay các kịch bản MIMO.
