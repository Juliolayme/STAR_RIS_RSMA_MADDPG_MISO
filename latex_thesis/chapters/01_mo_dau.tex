...
\item Đề xuất khuôn khổ MADDPG với ba tác tử chuyên dụng (BS Beamforming,
STAR-RIS Reflection, STAR-RIS Transmission), sử dụng ánh xạ pha tuyệt đối
trong cấu hình chính và hàm phần thưởng dạng Lagrangian với các hệ số phạt
$\lambda_k$ riêng cho từng người dùng,
...
\item Xây dựng nghiệm căn pha giải tích nhất quán với quy ước kênh MISO để
làm baseline vật lý và điểm khởi tạo cho các heuristic AO. Tham số hóa
residual được giữ như một ablation tùy chọn, không phải cấu hình chính.
...
kiến trúc ba tác tử chuyên dụng, mạng nơ-ron Actor-Critic, các cơ chế ổn định hóa (Lagrangian reward thích nghi, two-stage dual freeze) và quy trình huấn
luyện.
