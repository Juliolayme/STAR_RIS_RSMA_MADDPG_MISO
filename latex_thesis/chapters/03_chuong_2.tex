...
trong đó không gian trạng thái 1051 chiều được phân thành ba phần tương
...
% LUU Y: hinh h2_5/h2_6 can ve lai theo so chieu MISO moi (1051/1191) sau refactor.
\begin{figure}[t]
  \centering
  \includegraphics[width=0.96\linewidth]{figures/h2_5_mdp_anh_xa.png}
  \caption{Ánh xạ bài toán P0 sang MDP: không gian trạng thái 1051 chiều
  (tổng quan sát cục bộ ba tác tử), không gian hành động 140 chiều,
...
$73 + 577 + 401 = 1051$ (cấu hình chuẩn $M=4$, $K=4$, $K_R=3$, $N=32$).
