...
\input{tables/simulation_parameters.tex}
...
mới $\{70001, \ldots, 70005\}$. Danh sách phát triển, validation,
legacy $\{9101,\ldots,9505\}$ và final-test được đăng ký duy nhất tại
\texttt{config/seed\_split.v1.yaml}, SHA-256
\texttt{d73ba5aea6d037570f2634cbc87175db259a6e91f0fecee74519eecd1f118854};
...
\input{tables/sumrate_vs_power.tex}
...
SISO khảo sát, chi phí điều phối ba tác tử được bù trừ vừa đủ bởi lợi
...
đáng kể nhờ biên độ residual $\pm\pi/4$ (mục \ref{sec:residual_phase}):
...
\textbf{(K5) Tham số hóa pha residual giúp hội tụ ổn định và tiệm cận
nghiệm giải tích.} Đường cong hội tụ của MADDPG (Hình
\ref{fig:training_sum_rate}) cải thiện đều đặn từ episode đầu tiên;
với biên độ residual $\pm\pi/4$, chính sách học đạt sum-rate tương
đương thống kê với nghiệm căn pha đóng MaxMinAligned trong khi vẫn
phối hợp được với phân bổ công suất.
