...
\addlinespace
A3. Truyền đường xuống một cell, BS nhiều anten ở cấu hình MISO ($M=4$ mặc định) &
Mô hình MISO phản ánh beamforming đường xuống của RSMA; vẫn giữ một cell để cô lập tác động của STAR-RIS, phân rã đa tác tử và ràng buộc QoS. \\
\addlinespace
