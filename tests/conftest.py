...
def base_env_cfg(**overrides) -> dict:
    cfg = {
        ...
        "bs_power_logit_scale": 1.5,
        "bs_power_action_clip": 0.9,
        "bs_min_stream_power_fraction": 0.02,
        "bs_common_beam_logit_scale": 1.0,
        "bs_common_beam_action_clip": 0.9,
        "bs_rzf_regularization": 0.05,
        "bs_rzf_mix_prior": 0.95,
        "bs_rzf_mix_span": 0.05,
        "force_equal_stream_power": False,
        "force_mrt_directions": False,
        "force_uniform_common_split": False,
        "force_uniform_common_beam": False,
        "equal_power_mode": False,
        "phase_action_mode": "residual",
        "phase_residual_scale": 0.15,
